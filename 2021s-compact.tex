...
\begin{document}
{\huge Sommersemester 2021}\hfill\vslogo
...
\begin{tikzpicture}
\calendar[dates=2021-04-01 to 2021-09-30,%
week list,month label left,month yshift=0,day yshift=2em%
] (2021s)%
if (at most=2021-04-18) [uulm-akzent!75] else [black!80]
if (at least=2021-07-31) [uulm-akzent!75]
%
if (weekend) [uulm-akzent!40]
if (day of month=1) [first]
% Feiertage
if (equals=2021-05-01) [feiertag] % Tag der Arbeit
if (equals=2021-05-13) [feiertag] % Christi Himmelfahrt
if (equals=2021-05-24) [feiertag] % Pfingstmontag
if (equals=2021-06-03) [feiertag] % Fronleichnam
%
;

\coordinate (top) at (2021s-2021-04-04.south east);
\coordinate (bottom) at (2021s-2021-04-04.south east |- 2021s-2021-09-30.south east);
