...
\begin{document}
{\huge Sommersemester 2016}\hfill\vslogo
...
\begin{tikzpicture}
\calendar[dates=2016-04-01 to 2016-07-31,%
week list,month label left,month yshift=0,day yshift=2em%
] (2016s)%
if (at most=2016-04-11) [uulm-akzent!40] else [uulm-akzent]
if (at least=2016-07-16) [uulm-akzent!40]
% Feiertage
if (equals=2015-05-01) [first,feiertag]
if (equals=2015-05-05) [feiertag]
if (equals=2015-05-16) [feiertag]
if (equals=2015-05-26) [feiertag]
%
if (weekend) [uulm-akzent!40]
if (day of month=1) [first]
;

\coordinate (top) at (2016s-2016-04-03.south east);
\coordinate (bottom) at (2016s-2016-04-03.south east |- 2016s-2016-07-31.south east);
