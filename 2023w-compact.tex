...
\par\vspace{2em}
\noindent{\large Wintersemester 2023/2024}
\vspace{1em}
...
\noindent\begin{tikzpicture}
\calendar[dates=2023-09-26 to 2024-03-31,%
week list,month label left,month yshift=0,day yshift=2em%
] (2023w)%
if (at most=2023-10-16) [uulm-akzent!40] else [black!80]
if (at least=2024-02-17) [uulm-akzent!40]
if (between=2023-12-24 and 2024-01-05) [uulm-akzent!40]
if (at most=2023-09-30) [uulm-akzent!10]
% Feiertage
if (equals=2023-10-03) [feiertag]
if (equals=2023-11-01) [feiertag]
if (equals=2023-12-25) [feiertag]
if (equals=2023-12-26) [feiertag]
...
% Semesterbeginn/-ende
if (equals=2023-10-16) [semester]
if (equals=2024-02-16) [semester]
;

\coordinate (top) at (2023w-2023-09-26.south east);
\coordinate (bottom) at (2023w-2024-03-27.south east |- 2023w-2024-03-31.south east);
