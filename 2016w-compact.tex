...
\noindent\begin{tikzpicture}
\calendar[dates=2016-10-01 to 2017-03-31,%
week list,month label left,month yshift=0,day yshift=2em%
] (2016w)%
if (at most=2016-10-17) [uulm-akzent!40] else [uulm-akzent]
if (at least=2017-02-18) [uulm-akzent!40]
if (between=2016-12-24 and 2017-01-05) [uulm-akzent!40]
% Feiertage
if (equals=2016-10-03) [feiertag]
if (equals=2016-11-01) [feiertag]
if (equals=2017-01-01) [feiertag]
if (equals=2017-01-06) [feiertag]
%
if (weekend) [uulm-akzent!40]
if (day of month=1) [first]
% Semesterbeginn/-ende
if (equals=2016-10-17) [semester]
if (equals=2017-02-18) [semester]
;

\coordinate (top) at (2016w-2016-10-02.south east);
\coordinate (bottom) at (2016w-2017-03-26.south east |- 2016w-2017-03-31.south east);
