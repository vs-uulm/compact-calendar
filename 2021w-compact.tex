...
\par\vspace{2em}
\noindent{\large Wintersemester 2021/2022}
\vspace{1em}
...
\noindent\begin{tikzpicture}
\calendar[dates=2021-09-28 to 2022-03-31,%
week list,month label left,month yshift=0,day yshift=2em%
] (2021w)%
if (at most=2021-10-18) [uulm-akzent!40] else [black!80]
if (at least=2022-02-19) [uulm-akzent!40]
if (between=2021-12-24 and 2022-01-05) [uulm-akzent!40]
if (at most=2021-09-30) [uulm-akzent!10]
% Feiertage
if (equals=2021-10-03) [feiertag]
if (equals=2021-11-01) [feiertag]
if (equals=2021-12-25) [feiertag]
if (equals=2021-12-26) [feiertag]
if (equals=2022-01-01) [feiertag]
if (equals=2022-01-06) [feiertag]
%
if (weekend) [uulm-akzent!40]
if (day of month=1) [first]
% Semesterbeginn/-ende
if (equals=2021-10-18) [semester]
if (equals=2022-02-18) [semester]
;

\coordinate (top) at (2021w-2021-09-28.south east);
\coordinate (bottom) at (2021w-2022-03-29.south east |- 2021w-2022-03-31.south east);
