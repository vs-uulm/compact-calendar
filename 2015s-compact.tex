...
\begin{document}
{\huge Sommersemester 2015}\hfill\vslogo
...
\begin{tikzpicture}
\calendar[dates=2015-04-01 to 2015-08-31,%
week list,month label left,month yshift=0,day yshift=2em%
] (2015s)%
if (at most=2015-04-13) [uulm-akzent!40] else [uulm-akzent]
if (at least=2015-07-18) [uulm-akzent!40]
% Feiertage
if (equals=2015-05-01) [first,feiertag]
if (equals=2015-05-14) [feiertag]
if (equals=2015-05-25) [feiertag]
if (equals=2015-06-04) [feiertag]
%
if (weekend) [uulm-akzent!40]
if (day of month=1) [first]
;

\coordinate (top) at (2015s-2015-04-06.south east);
\coordinate (bottom) at (2015s-2015-04-06.south east |- 2015s-2015-08-31.south east);
