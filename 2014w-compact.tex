...
\noindent\begin{tikzpicture}
\calendar[dates=2014-10-01 to 2015-02-28,%
week list,month label left,month yshift=0,day yshift=2em%
] (2014w)%
if (at most=2014-10-13) [uulm-akzent!40] else [uulm-akzent]
if (at least=2015-02-14) [uulm-akzent!40]
if (between=2014-12-24 and 2015-01-05) [uulm-akzent!40]
% Feiertage
if (equals=2014-10-03) [feiertag]
%
if (weekend) [uulm-akzent!40]
if (day of month=1) [first]
% Semesterbeginn/-ende
if (equals=2014-10-13) [semester]
if (equals=2015-02-14) [semester]
;

\coordinate (top) at (2014w-2014-10-05.south east);
\coordinate (bottom) at (2014w-2015-02-22.south east |- 2014w-2015-02-28.south east);
